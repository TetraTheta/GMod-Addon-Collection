...
--
-- sc_flashlight_auto <0|1> - Automatically enable flashlight to all players.
--
local scFlashlightAuto = "sc_flashlight_auto"
if not ConVarExists(scFlashlightAuto) then
  CreateConVar(scFlashlightAuto, "0", flags, "Disable player-to-player collision", 0, 1)
end
